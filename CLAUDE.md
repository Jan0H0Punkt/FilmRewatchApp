...
**The core domain (M1) and the rewatch engine (M4), scoring included, are built.** Remaining open items are listed in `docs/requirements/OPEN_DECISIONS_V1.md`. Do not add logic to a milestone that doesn't own it (see the out-of-scope table in the relevant milestone doc). This discipline applies to **both tiers**.

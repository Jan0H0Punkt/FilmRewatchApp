...
**Companion to:** [REQUIEREMENTS_V1.md](../requierements/REQUIEREMENTS_V1.md) · [FUTURE_WORK_V1.md](../requierements/FUTURE_WORK_V1.md) · [OPEN_DECISIONS_V1.md](../requierements/OPEN_DECISIONS_V1.md)  
...
The [requirements document](../requierements/REQUIEREMENTS_V1.md) defines *what* the application must do and the binding
...
[OPEN_DECISIONS](../requierements/OPEN_DECISIONS_V1.md).
...
- **[Future Work & Deferred Items](../requierements/FUTURE_WORK_V1.md)** — "maybe later" work intentionally out of scope for
  this version: global tag/genre delete (FR-TAG-05), Rewatch list filtering, CI/CD automation.
- **[Open Decisions](../requierements/OPEN_DECISIONS_V1.md)** — choices still to make: M0 confirmations (database engine,
